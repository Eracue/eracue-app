...
export default async function SubmitPage() {
 ...
 <h1 className="text-3xl font-light tracking-tight text-[#1C1C1A] mt-2">Submit a draft</h1>
 <p className="text-sm text-[#6E6E68] mt-1">Drafts are checked against active rules before publication.</p>
 <p className="text-sm text-[#6E6E68] mt-3 max-w-xl">
