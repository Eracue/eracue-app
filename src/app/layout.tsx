...
export const metadata: Metadata = {
  ...
  description:
    "ERA CUE checks every executive communication against your governance rules before publication. Named principal approval. Immutable audit trail. Communication record.",
};
